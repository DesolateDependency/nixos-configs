  ...
  programs.plasma = {
    ...
    shortcuts = {
      kwin = {
        ...
        "Window to Desktop 1" = "Meta+Ctrl+1"; # Default: Meta+Ctrl+1
        "Window to Desktop 2" = "Meta+Ctrl+2"; # Default: Meta+Ctrl+2
        "Window to Desktop 3" = "Meta+Ctrl+3"; # Default: Meta+Ctrl+3
        "Window to Desktop 4" = "Meta+Ctrl+4"; # Default: Meta+Ctrl+4
        "Window to Desktop 5" = "Meta+Ctrl+5"; # Default: Meta+Ctrl+5
        "Window to Desktop 6" = "Meta+Ctrl+6"; # Default: Meta+Ctrl+6
        "Window to Desktop 7" = "Meta+Ctrl+7"; # Default: Meta+Ctrl+7
        "Window to Desktop 8" = "Meta+Ctrl+8"; # Default: Meta+Ctrl+8
        "Window to Desktop 9" = "Meta+Ctrl+9"; # Default: Meta+Ctrl+9
        ...
        "Window One Desktop Down" = "Meta+Ctrl+Down"; # Default: Meta+Ctrl+Shift+Down
